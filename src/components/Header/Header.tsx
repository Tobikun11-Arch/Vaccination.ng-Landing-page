...
export default function Header() {
    ...
    return (
        <header className={`fixed py-4 px-6 lg:py-4 lg:px-10 w-full flex items-center justify-between bg-[#0B153C] ${toggle && 'h-screen flex justify-center items-center z-50'}`}>
