  ...
  return (
    <main className="min-h-screen p-5 flex flex-col justify-center items-center w-full" id="services">
      <section className="bg-violet-700/10 shadow-lg backdrop-blur-xs w-full sm:w-3/5">
        ...
        <div className="pb-4 mt-3 px-4 sm:px-10 flex gap-3 w-full">
      ...
      <section className="mt-10 w-full lg:px-16">
        ...
        <div className="mt-6 w-full lg:flex gap-6 sm:px-0">
          <div className="w-full lg:w-full bg-white/25 shadow-lg backdrop-blur-sm px-6 pt-6 pb-14 rounded-b-4xl rounded-tl-4xl rounded-tr-[100px]">
          ...
          <div className="mt-5 lg:mt-0 flex flex-col sm:flex-row gap-4 w-full h-full">
