export default function Schedule() {
    return (
        <main className="bg-white text-black p-10 w-full">
            <section className="flex justify-between">
                ...
                <div className="w-full flex justify-center items-center">
                    <div className="relative flex justify-center items-center w-full">
                        <img src="/injection.jpg" alt="Injection vaccine" className="w-2/5 h-80 rounded-md"/>
                        <img src="/coronavirus.png" alt="coronavirus" className="absolute -top-6 left-34 w-20 h-16"/>
